$(function() {
  var handleWeatherResponse = function(data) {
    ...
    var markup = "<p>The weather report for now... " + data.currently.summary + "<p>Tomorrow: " + data.daily.data[0].summary + "<p>Day after: " + data.daily.data[1].summary + "<p> Day after day after: "+ data.daily.data[2].summary
